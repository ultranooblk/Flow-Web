...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      jacarta: {
        base: "#5A5D79",
        50: "#E0E5E8", // Slightly lighter than original (#F4F4F6)
        100: "#C9D0D7", // Slightly lighter than original (#E7E8EC)
        200: "#A5B1BC", // Slightly lighter than original (#C4C5CF)
        300: "#819AA7", // Slightly lighter than original (#A1A2B3)
        400: "#5E8191", // Slightly lighter than original (#7D7F96)
        500: "#3B697C", // Adjusted towards a cyan hue but maintains a bluish tone (#5A5D79)
        600: "#0D4F63", // Adjusted towards a cyan hue but maintains a bluish tone (#363A5D)
        700: "#00364D", // Adjusted towards a cyan hue but maintains a bluish tone (#131740)
        800: "#002B3E", // Adjusted towards a cyan hue but maintains a bluish tone (#101436)
        900: "#002131"  // Adjusted towards a cyan hue but maintains a bluish tone (#0D102D)
      }
